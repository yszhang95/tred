#!/bin/bash
#
# Response 25x25 single-variable run; see config comment.
...
ConfigFile="config_for_pgun_thres_prompt_hits_2pass_peakmode_dbin_hold15_resp25_20260704.yaml"
while IFS= read -r InFile; do
    ...
    OutFile="${odir}/pgun_mu_3GeV_2mm_thres_prompt_hits_2pass_peakmode_dbin_hold15_resp25_20260704.npz"
