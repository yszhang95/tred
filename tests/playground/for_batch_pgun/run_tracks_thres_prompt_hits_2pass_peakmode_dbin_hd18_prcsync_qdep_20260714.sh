...
ConfigFile="config_for_pgun_thres_prompt_hits_2pass_peakmode_dbin_hd18_prcsync_qdep_20260714.yaml"
while IFS= read -r InFile; do
    ...
    OutFile="${odir}/pgun_mu_3GeV_2mm_thres_prompt_hits_2pass_peakmode_dbin_hd18_prcsync_qdep_20260714.npz"
