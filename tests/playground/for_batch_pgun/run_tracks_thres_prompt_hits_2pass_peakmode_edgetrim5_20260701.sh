...
# (built by threshold_studies/make_threshold_peakmode.py from the combined
#  july10+11 q_hist, T = pile-up peak center - 0.2 ke, quality-flag masking,
#  plus the edgetrim5 disabled-channel set transplanted by make_edgetrim.py).
...
ConfigFile="config_for_pgun_thres_prompt_hits_2pass_peakmode_edgetrim5_20260701.yaml"
while IFS= read -r InFile; do
    ...
    OutFile="${odir}/pgun_mu_3GeV_2mm_thres_prompt_hits_2pass_peakmode_edgetrim5_20260701.npz"
